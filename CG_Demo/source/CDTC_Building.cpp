...
CDTC_Building::CDTC_Building(float _x, float _y, float _z)
{
	...
	building = glmReadOBJ("assets/CDTC_Building/CDTC_Building.obj");
	glmUnitize(building);
	glmScale(building, 0.15f);
...
CDTC_Building::~CDTC_Building()
{
}

void CDTC_Building::draw() {
	glPushMatrix();
	{
